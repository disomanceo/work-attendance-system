...
export async function authorizeAnnouncementRequest(request: Request) {
  const cfg = config();
  ...
  return {
    ...
    admin,
    user,
    profile: profile as AnnouncementProfile,
  };
}

export function isAnnouncementManager(role: string) {
